...
var Gallery = React.createClass({displayName: "Gallery",
  ...
  render: function() {
    var photos = this.state.photos.map(function(photo) {
      return React.createElement(Photo, {photo: photo, 
    ...
    return (
      React.createElement("div", {className: "gallery"}, 
        photos, 
        this.state.loaded ? null : React.createElement(Loader, null)
      )
    );
  }
});
...
},{"../Loader/Loader.jsx":2,"../Photo/Photo.jsx":3,"reqwest":6}],2:[function(require,module,exports){
var React = window.React;
  ...
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        React.createElement("img", {className: fillerClasses, 
        ...
        React.createElement("div", {className: photoClasses, 
          ...
          React.createElement("div", {className: "photo-content", 
            ...
            React.createElement("img", {className: "picture", 
                 src: this.props.photo.picture, 
                 alt: this.props.photo.text, 
                 onClick: this.props.onClick, 
                 onLoad: this.props.onLoad}), 
            React.createElement("p", {className: "caption"}, this.props.photo.text)
          )
        )
      )
    );
...
},{"classnames":5}],4:[function(require,module,exports){
var React = window.React;
var Gallery = require('./Gallery/Gallery.jsx');

React.render(React.createElement(Gallery, null), document.getElementById('app'));

},{"./Gallery/Gallery.jsx":1}],5:[function(require,module,exports){
/*!
